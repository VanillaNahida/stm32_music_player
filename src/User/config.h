...
#define MUSIC_MAX_POLYPHONY     8u       /* 最大同时发声数（复音数） */
#define MUSIC_MASTER_VOLUME_Q8  255u     /* 主音量：0~256，256=100%（越大越响） */
...
#define MUSIC_DECAY_TIME_MS     2500u     /* 衰减时间：600ms（0.6s），0.1~10s 可选 */
...
#define MUSIC_TRACK_VOLUME_Q8   {256, 256}   /* 每轨音量：256=100% */

/* ---- 曲目：main.c 通过该宏引入乐谱头文件 ---- */
#define MUSIC_SCORE_INCLUDE     "music/Constant_Moderato.h"
